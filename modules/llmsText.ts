...
- **Seats.** \`seats\` is the configuration the Icelandic seller lists at that price. A third row sold as a paid extra is not counted, so a car that *can* be had as a seven-seater here may still read \`5\`. Say "as standard" when you quote it.
