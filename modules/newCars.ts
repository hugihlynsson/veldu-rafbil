...
const newCars: Array<NewCar> = [
  ...
  },
  {
    ...
    range: 522,
    evDatabaseURL:
      'https://ev-database.org/car/1556/Volkswagen-ID5-Pro',
    drive: 'RWD',
    power: 128,
    timeToCharge10T080: 33,
  },
  ...
  },
  {
    ...
    capacity: 78,
    range: 418,
    evDatabaseURL: 'https://ev-database.org/car/1593/Volvo-XC40-Recharge-Twin-Pure-Electric',
    drive: 'AWD',
    power: 300,
    timeToCharge10T080: 33,
  },
...
export const expectedCars: Array<ExpectedCar> = [
  ...
  },
  {
    ...
    price: 7600000,
    sellerURL: 'https://www.mercedes-benz.com/en/vehicles/passenger-cars/eqb/',
    acceleration: 9.1,
    capacity: 66.5,
    range: 422,
    expectedDelivery: 'Sumar 2022',
  ...
  },
  {
    ...
    price: 4990000,
    sellerURL: 'https://www.renault.is/cars/megane-e-tech/megane-e-tech-electric.html',
    acceleration: 10.0,
    capacity: 40,
    range: 300,
